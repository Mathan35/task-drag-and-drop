...
@section('content')
    ...
    <div class=" container min-screen-lg mx-auto">
        <div class="bg-gray-100 border border-gray-300 rounded shadow-sm py-10 my-10 px-5">
            ...
            <div class="">
                <h2 class="text-lg font-sans font-medium text-blue-500 px-2 py-1">Add Task</h2>

                <form action="{{route('store-task')}}" method="POST">
                    @csrf
                <div class="mb-6">
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Task name</label>
                    <input type="te" id="" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  focus:border-blue-300 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                </div>
